...
const items = [
  ...
  { id: 5, name: "Game Design", description: "The goal for this project was to explore tabletop game design and concept buidling by creating a variety of design layouts for cards and diverse rulesets using programs like Affinity Pro, Canvas and Dextrous.", url: "https://canva.link/voikgpdtam6886f" }
]
